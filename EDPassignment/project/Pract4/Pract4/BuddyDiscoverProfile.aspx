<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BuddyDiscoverProfile.aspx.cs" Inherits="Pract4.BuddyDiscoverProfile" %>
    ...
    <div id="div2" class="col-sm-6" align="right">
        ...
        <div id="div3" class="col-sm-6">
            ...
            <div class="container4" align="left">
                <asp:Button ID="Button1" runat="server" Text="Contact" BorderColor="#CC6699" />
                &nbsp;
                <asp:Button ID="Button2" runat="server" Text="Next" BorderColor="Black" OnClick="Button2_Click" Width="69px" />
                <br />
                <br />
                ...
                <asp:Label ID="listNum" runat="server" Text="Label" Visible="False"></asp:Label>
            </div>
